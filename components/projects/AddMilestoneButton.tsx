...
export function AddMilestoneButton({ projects, defaultProjectId }: AddMilestoneButtonProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          <div className="glass rounded-2xl w-full max-w-[400px] mx-4 overflow-hidden shadow-[0_24px_48px_rgba(0,0,0,0.15)]">
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/50">
              <span className="text-[15px] font-bold text-[#0f172a]">Add Milestone</span>
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[12.5px] font-semibold text-[#0f172a]">Milestone Title</label>
                <input
                  name="title" type="text" required placeholder="e.g. Design Phase"
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  name="description" rows={2} placeholder="Brief description of this milestone"
