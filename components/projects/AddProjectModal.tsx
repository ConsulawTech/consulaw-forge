...
export function AddProjectModal({ clients, preselectedClientId, onClose }: AddProjectModalProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    setError("");
    const result = await createProjectAction(new FormData(formRef.current));
    setLoading(false);
    if (!result.success) {
          ...
          <div className="p-6 flex flex-col items-center gap-4 text-center">
            ...
            <div>
              ...
              <div className="text-[13px] text-[#475569] mt-1">
                Add milestones and tasks to get started.
              </div>
            </div>
            <button
              onClick={onClose}
